...
task_list = {
    ...
    26: "[2 points] Obtain a Slepey Tablet and any Nightmare Unique (Staff, Inquisitor, Orb, Pet, Jar, Egg)",
    ...
    31: '[5 points] Least deaths wins. Nominate your Champion. "PK" opposing teams while completing ToB. One point goes to the team whose member has the least deaths',
    ...
    82: "[5 points] Most gp earned in 1 hour on a fresh lvl 3 FTP ironman - final screenshot must include time played and be less than 60 minutes",
